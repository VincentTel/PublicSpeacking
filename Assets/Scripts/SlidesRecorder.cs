...
public class SlidesRecorder : MonoBehaviour
{
    [Tooltip("Path to the file used to record or replay the recorded data.")]
    public string fileName = "SlideRecording.txt";
    ...
    private static SlidesRecorder instance = null;
    ...
    public static SlidesRecorder Instance
    {
        get
        {
            return instance;
    ...
    void Start()
    {
        ...
        {
            Debug.Log("PresentationManager not found, probably not initialized.");
        }
    ...
    void Update()
    {
        if (isRecording)
        {
            ...
            string sBodyFrame = presentationManager.GetCurrentSlide().ToString();
        ...
        if (isPlaying)
        {
            ...
            {
                // then play the line
                if (presentationManager && sPlayLine.Length > 0)
                {
                    presentationManager.SetSlidesData(sPlayLine);
                }
