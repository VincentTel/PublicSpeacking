...
public class ScoreRecorder : MonoBehaviour
{
    ...
    void Update()
    {
        if (isRecording)
        {
            ...
            string sBodyFrame = scoreManager.GetScore().ToString();
        ...
        if (isPlaying)
        {
            ...
            {
                // then play the line
                if (scoreManager && sPlayLine.Length > 0)
                {
                    scoreManager.SetScoreData(sPlayLine);
                }
